...
const ReadingGroup = ({ readingGroup, showReadingGroupInfoModal }) => {
    return (
        readingGroup && (
            <>
                <div

                    onClick={(e) => { showReadingGroupInfoModal(); e.stopPropagation() }}
                    ...
                    <div className="w-full xl:w-1/4 md:w-1/2 lg:ml-auto" style={{ zindex: 10000 }}>
                        <div className="relative flex flex-col h-full p-8">
                            <h1 className="flex items-end mx-auto text-3xl font-black leading-none text-white ">
                                <span>View Reading Group </span>
                            </h1>
                            <div className="flex flex-col md:flex-row">

                                <a
                                    href={`${readingGroup?.url}`}
